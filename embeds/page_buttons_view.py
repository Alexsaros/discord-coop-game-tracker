...
class PageButtonsView(View):
    ...
    def __init__(self, bot: Bot, embed_title: str, message_id: int, update_function: callable, function_argument):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        try:
            ...
            await self.update_function(self.bot, self.function_argument, new_page)
